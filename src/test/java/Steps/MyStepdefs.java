...
public class MyStepdefs extends BaseUtil {
    ...
    public void iGetKPICountForDueIn30Mins() throws Throwable {
        Loginpage page = new Loginpage(base.driver);
        page.Due30();
        Thread.sleep(3000);
    }
    ...
    @And("^I access certs page$")
    public void iAccessCertsPage() throws Throwable {
        System.out.println("Access certs page");
        Loginpage page = new Loginpage(base.driver);
        Thread.sleep(3000);
        driver.navigate().to("https://wot.patracorp.net/Certs");
        Thread.sleep(5000);
    ...
    public void iVerifyTheDiscardedReasonDropDownFunctionality(DataTable table) throws Throwable {
        System.out.println("Verify the discarded reason functionality");
        List<discardreason> disreason = new ArrayList<discardreason>();
        disreason = table.asList(discardreason.class);
        Loginpage page = new Loginpage(base.driver);
        Thread.sleep(2000);
        for (discardreason reason : disreason){
            page.textdisreason(reason.discardedreason);
        }

    }
    */
/*
    @And("^I edit the WO by changing the due date override$")
    public void iEditTheWOByChangingTheDueDateOverrideToVerifySLAMissedReason() throws Throwable {
        System.out.println("Change the due date");
        Loginpage page = new Loginpage(base.driver);
        page.duedate();
    }

    @And("^I select the task completed check box to verify SLA missed reason$")
    public void iSelectTheTaskCompletedCheckBoxToVerifySLAMissedReason() throws Throwable {
        System.out.println("SLA missed reason drop down");
        Loginpage page = new Loginpage(base.driver);
        page.slamissedreason();
    }
    */

    @And("^I select the SLA miss reason$")
    public void iSelectTheSLAMissReason() throws Throwable {
        System.out.println("Select SLA miss reason");
        Loginpage page = new Loginpage(base.driver);
        page.slamissedreason();
    }

    @And("^I click on Save button to verify user friendly message$")
    public void iClickOnSaveButtonToVerifyUserFriendlyMessage() throws Throwable {
       System.out.println("Verify user friendly message");
        Loginpage page = new Loginpage(base.driver);
        page.usrfriendly();
    ...
    public void iSelectIncorrectInsuredToVerifyScore() throws Throwable {
        System.out.println("Verify score for Incorrect Insured");
        Loginpage page = new Loginpage(base.driver);
        page.newqa();
    }

    @And("^selects the discarded reason$")
    public void selectsTheDiscardedReason() throws Throwable {
      System.out.println("Select Discarded Reason");
      Loginpage page = new Loginpage(base.driver);
      page.discardreason();
    }

    @And("^I search a wo$")
    public void iSearchAWo(DataTable table) throws Throwable {
        System.out.println("To verify discarded reason");
        List<disreason> disreasons = new ArrayList<disreason>();
        disreasons = table.asList(disreason.class);
        Loginpage page = new Loginpage(base.driver);
        for (disreason disreasonss : disreasons ){
            page.reasonsdiscard(disreasonss.discardwo,disreasonss.summary);
    ...
    @And("^I verify the Discarded reason drop down functionality$")
    public void iVerifyTheDiscardedReasonDropDownFunctionality(DataTable table) throws Throwable {
        System.out.println("Select Discard Reason dropdown");
        List<reasondd> reasondds = new ArrayList<reasondd>();
        reasondds = table.asList(reasondd.class);
        Loginpage page = new Loginpage(base.driver);
        for (reasondd reasonddss : reasondds){
            page.reasondropdown(reasonddss.discardedreason);
    ...
    public void iSelectTheSLAMetColumnToNo() throws Throwable {
       System.out.println("Select SLA MET to No");
       Loginpage page = new Loginpage(base.driver);
       page.slamet();
    ...
    public void iClickOnGlibresultsTab() throws Throwable {
        System.out.println("Click on Glib Results tab");
        Loginpage page = new Loginpage(base.driver);
        page.glib();
    }

    @And("^I enter addtional insured team score$")
    public void iEnterAddtionalInsuredTeamScore() throws Throwable {
        System.out.println("Enter additional insured teamscore");
        Loginpage page = new Loginpage(base.driver);
        page.addinsured();
        }

    @And("^I enter cert holder team score$")
    public void iEnterCertHolderTeamScore() throws Throwable {
        System.out.println("Enter Cert holder teamscore");
        Loginpage page = new Loginpage(base.driver);
        page.certholder();
    }

    @And("^click on save button for glib$")
    public void clickOnSaveButtonForGlib() throws Throwable {
      System.out.println("Click on save button in Glib results tab");
      Loginpage page = new Loginpage(base.driver);
      page.glibsave();
    }


    public class reasondd{
        public String discardedreason;

        public reasondd(String discardedreasons){
            discardedreason = discardedreasons;
        }
    }


    public class disreason{
        public String discardwo ;
        public String summary;

        public disreason(String Discardwo, String Summary1){
            discardwo = Discardwo;
            summary = Summary1;
        }
    }
    ...
    public class discardreason{
        ...
        public discardreason(String txtdiscardedreason){
           discardedreason = txtdiscardedreason;
        }
    ...
    public class CompletedWosearch {
        ...
        public String completedsummary;// clientcode, noofcerts, rushbulk;

        public CompletedWosearch(String CompletedWo, String ClientCode, String Noofcerts, String RushBulk ,String CompletedSummary) {
