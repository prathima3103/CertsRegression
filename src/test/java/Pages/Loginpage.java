...
public class Loginpage extends BaseUtil {
    ...
    @FindBy(how = How.CSS, using = "body > div.container-fluid > div > div > div > div > a:nth-child(1) > div > div:nth-child(1)")
    ...
    @FindBy(how = How.XPATH, using = "/html/body/div[4]/div[1]/div/div/div/ul/li[3]/button")
    //Print PDF button html/body/div[3]/div[1]/div/div/div/ul/li[3]/button
...
//Intitializing elements in Processing work order form
    ...
    @FindBy(how = How.XPATH, using = "/html/body/div[12]/div[2]/div/div/div/div/div/div/div/div[4]/button")
    //Delievry Alert OK
...
//Intitializing elements in Processing work order form - Detail Tab
   ...
   */
    ...
    @FindBy(how = How.CSS, using = "#kpi3 > div.details")   //KPI Delievry
    ...
    @FindBy(how = How.CSS, using = "#dtprocessing > tbody > tr:nth-child(1) > td:nth-child(1) > a")
    //KPI Delievry wo#861326
    public WebElement kpiwonum;
    @FindBy(how = How.CSS, using = "#dt-incoming-responses > tbody > tr > td:nth-child(1) > a")
    //clicking WO incoming resp
    ...
    @FindBy(how = How.CSS, using = "#the-basics-new > span > div > div > p > a > strong")
    //#1077636 - Global Search link select
    public WebElement linkGlobalSearchSelection;

    @FindBy(how = How.CSS, using = "body > header > nav > div > div > div.col-md-3.col-sm-3.col-xs-12.patraheaderp3 > div.topbar-actions > div > button")
    //Logout
    ...
    @FindBy(how = How.XPATH, using = "/html/body/header/nav/div/div/div[3]/div[1]/div/ul/li[15]/a/h4")
    ...
    public void WorkOrderSearch(String wo, String clientcode, String summary) {
        try {
            Thread.sleep(2000);
            wosearch.sendKeys(wo);
            Thread.sleep(5000);
    ...
    public void EditWO() {
        try {
            ProcSummary.sendKeys("summary edit");
            Thread.sleep(2000);
    ...
    public void deliveryalert() {
        try {
            ...
            System.out.println("unable to click on OK");
        }
    ...
    public void editkpidelrec() {
        try {
            ...
            System.out.println("Uanble to select the WO");
        }
    }
    ...
    {
        System.out.println("Uanble to Click on Reset");
    }
    ...
    public void ResetbtnCompletedtab() {
        try{
            ...
            System.out.println("Unable to click on Completed tab");
        }
    ...
    @FindBy(how = How.ID, using = "kpi8")      // pending responses KPI  kpi8Count
   ...
   /* @FindBy(how = How.CSS, using = "#th-RushBulkCompleted > ul > li:nth-child(2) > span > div > button")
    ...
    public void Compltdwonum (String completedWO) {  //String clientcode, String noofcerts, String rushbulk
        ...
        //tpmsortingclientcode.sendKeys("");
        tpmsortingsummary.sendKeys("march15test");
    ...
    public void DiscardedWOSubmit() {
        try {
            Thread.sleep(3000);
            txtdiscardreason.sendKeys("As per AM's response");
            submit.click();
        }
        catch (Exception e){}
    }
    ...
    @FindBy(how = How.ID, using = "kpi5")
    public WebElement DuekpiValueTotal;
    @FindBy(how = How.ID, using = "kpi6")
    ...
    public void PastDueKPIvalue() {
        PastDuekpiValueTotal.click();
        String PastKPITotalCount = PastDuekpiValueTotal.getText();
        System.out.println("Past Due Total Count is :" + PastKPITotalCount);
    }

    @FindBy(how = How.ID, using = "cert_DiscardedReasons")
    public WebElement txtdiscardreason;


    public void textdisreason(String discardedreason){
        try {

            ProcStatus.sendKeys("Discarded");
            Thread.sleep(2000);
            Foldername.sendKeys("Discarded Work Orders");
            Thread.sleep(2000);
            txtdiscardreason.sendKeys("As per AM's response");
            Thread.sleep(2000);
        }
    ...
    public void duedate(){
        ProcDueDateverride.sendKeys("01/01/2019 1:00 AM ");
        submit.click();

    }

    @FindBy(how = How.ID, using = "cert_SLAMissReasonID")
    public WebElement missreason;

    public void slamissedreason(){
        Select missreasn = new Select(missreason);
        missreasn.selectByVisibleText("Complicated request");
        submit.click();
        CloseWO.click();
    }

    @FindBy(how = How.ID, using = "QA_fill_error_msg")
    public WebElement usrmsg;

    public void usrfriendly(){
        qasubmit.click();
        //Assert.assertEquals(usrmsg,"please fill the QA Details");
       // String str = new String();
        System.out.println("User friendly message is :" + usrmsg );
    }

    @FindBy(how = How.ID, using = "incorrect_insured_1")
    public WebElement incorrectqa;

    @FindBy(how = How.ID, using = "cert_Qa_Score")
    public WebElement qascore;

    @FindBy(how = How.XPATH, using ="//*[@id=\"QA\"]/div/div[1]/div/div[1]/button[2]")
    public WebElement clearbttn;

    @FindBy(how = How.ID, using = "incorrect_insured_2")
    public WebElement question2a;
    ...
    public void newqa(){
        try {
            incorrectqa.click();
            Thread.sleep(3000);
            // Assert.assertEquals(qascore,"0");
            System.out.println("QA Score is 0");
            //to verify the clear button functionality
            clearbttn.click();
            Thread.sleep(3000);
            //select the second question
            question2a.click();
            Thread.sleep(3000);
            //  Assert.assertEquals(qascore,80);
            System.out.println("QA Score is 80");
            Thread.sleep(3000);
            qasubmit.click();
            Thread.sleep(3000);
            submit.click();
    ...
    @FindBy(how = How.ID,using = "SummaryToBEdiscarded")
    public WebElement tobediscardsum;

    @FindBy(how = How.CSS,using = "#dt-tobeDiscarded > tbody > tr.red-grid.odd > td:nth-child(2) > a")
    public WebElement tobediscardwo;

    public void reasonsdiscard(String summary,String discardwo){
        try{
            tobediscardsum.sendKeys(summary);
            Thread.sleep(3000);
            tobediscardwo.click();
            Thread.sleep(3000);
            }
        ...
        @FindBy(how = How.ID,using = "cert_SLAMissReasonID")
        public WebElement slamissreason;

        public void reasondropdown(String discardedreason){
            slamissreason.sendKeys(discardedreason);
            submit.click();
            CloseWO.click();

        }

        @FindBy(how = How.CSS,using = "#th-IsSLAMetCompleted > span > div > button > span")
        public WebElement slametcol;

        @FindBy(how = How.CSS,using = "#th-IsSLAMetCompleted > span > div > ul > li:nth-child(3) > a > label > input[type=\"checkbox\"]")
        public WebElement slametno;

        @FindBy(how = How.ID,using = "IsUpdateCompleted")
        public WebElement updatecol;

        @FindBy(how = How.CSS,using = "#dtcompleted > tbody > tr:nth-child(1) > td:nth-child(1) > a")
       ...
       @FindBy(how = How.ID,using = "glibs_sects")
       public WebElement glibtab;

      // @FindBy(how = How.CLASS_NAME,using = "glibs_AdditionalInsured")
     //   public WebElement aiteamselect;

      // @FindBy(how = How.CLASS_NAME,using = "glibs_CertHolder")
    ...
    @FindBy(how = How.ID,using = "Glib_IsTeamSelected_81204")
    public WebElement ai;

    @FindBy(how = How.ID,using = "Glib_TeamScore_81204")
    public WebElement aiscore;

    @FindBy(how = How.ID,using = "Glib_IsTeamSelected_81201")
    public WebElement certholdr;

    @FindBy(how = How.ID,using = "Glib_TeamScore_81201")
    public WebElement certscore;

    @FindBy(how = How.ID,using = "Glib_submit")
    public WebElement glibsubmit;
    ...
    public void certholder() {
        try {
            Thread.sleep(2000);
            certholdr.click();
            Thread.sleep(2000);
            certscore.sendKeys("20");
        } catch (Exception e) {
        }
    }
    public void glibsave(){
        glibsubmit.click();
        submit.click();
        CloseWO.click();
